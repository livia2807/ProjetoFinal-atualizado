...
export default function LoginScreen() {
  ...
  const handleEmployeeLogin = () => {
    if (selectedWorker) {
      // Salva o ID do funcionário para usar nas denúncias
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-sm border border-[#e0e0e0] overflow-hidden">
              ...
              <div className="p-8">
                ...
                <div className="flex flex-col gap-3">
                  <button
                    ...
                    className="p-4 rounded-xl border-2 border-[#e0e0e0] hover:border-[#777777] transition-all text-left"
                  >
            ...
            {view === 'employee' && (
              <div className="p-8">
                <button onClick={() => setView('choose')} className="text-sm text-[#777777] mb-6">
                  Voltar
                </button>
            ...
            {view === 'employer' && (
              <div className="p-8">
                ...
                {passErr && (
                  <p className="text-red-500 text-sm mb-3">Senha incorreta</p>
                )}
